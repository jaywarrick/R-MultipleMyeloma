...
# fwrite(x, file.path = 'Y:/Jay/JEXDatabases/R Analysis/RC3 20161004/x.csv')
x <- fread(input = 'Y:/Jay/JEXDatabases/R Analysis/RC3 20161004/x.csv')
...
# fwrite(maps, file.path = 'Y:/Jay/JEXDatabases/R Analysis/RC3 20161004/maps.csv')
maps <- fread(input = 'Y:/Jay/JEXDatabases/R Analysis/RC3 20161004/maps.csv')
...
fwrite(propTestResults, file.path='Y:/Jay/JEXDatabases/R Analysis/RC3 20161004/tTestResults.csv')
