...
x <- fread(input = 'Y:/Jay/JEXDatabases/R Analysis/RC3 20161004/x_BMES.csv')
...
maps <- fread(input = 'Y:/Jay/JEXDatabases/R Analysis/RC3 20161004/maps_BMES.csv')
...
fwrite(propTestResults, file.path='Y:/Jay/JEXDatabases/R Analysis/RC3 20161004/propTestResults_BMES.csv')
