...
x <- fread(input = '/Volumes/Seagate Backup Plus Drive/Materials for BMES/R Analysis/RC3 20161004/x_BMES.csv')
...
maps <- fread(input = '/Volumes/Seagate Backup Plus Drive/Materials for BMES/R Analysis/RC3 20161004/maps_BMES.csv')
...
fwrite(propTestResults, file.path='/Volumes/Seagate Backup Plus Drive/Materials for BMES/R Analysis/RC3 20161004/propTestResults_BMES.csv')
...
write.csv(x=CompiledTable, file='/Volumes/Seagate Backup Plus Drive/Materials for BMES/R Analysis/RC3 20161004/CompiledTable_BMES.csv')